...
Vidibus::ValidateUri is tested against Ruby 1.8.7.

http://travis-ci.org/vidibus/vidibus-validate_uri.png  {Build History}[http://travis-ci.org/vidibus/vidibus-validate_uri]
